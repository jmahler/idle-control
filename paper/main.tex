...
\begin{figure}[htbp!]
\begin{center}
\includegraphics[scale=0.7]{../octave/em_plot1}
\end{center}
...
\begin{figure}[htbp!]
\begin{center}
\includegraphics[scale=0.7]{../octave/em_plot2}
\end{center}
...
\begin{figure}[htbp!]
\begin{center}
\includegraphics[scale=0.6]{../octave/em_plot4}
\end{center}
...
\begin{figure}[htbp!]
\begin{center}
\includegraphics[scale=0.6]{../octave/dd_plot2}
\end{center}
...
While these results were positive it is not obvious whether it is withing
...
\begin{figure}[htbp!]
\includegraphics[scale=0.7]{../octave/cd_plot1}
...
\begin{figure}[htbp!]
\includegraphics[scale=0.7]{../octave/cd_plot2}
...
% {{{ fig:dc_plot2
\begin{figure}[htbp!]
\includegraphics[scale=0.7]{../octave/dc_plot2}
...
\begin{figure}[htbp!]
\begin{center}
\includegraphics[scale=0.5]{../octave/em_plot3}
\end{center}
